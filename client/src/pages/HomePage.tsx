        ...
        <div>
            ...
            {user ? (
                ...
                <section className="py-0 bg-cream text-center">
                    ...
                    <p className="text-gray-500 mb-8">Sign up to explore campus life, events, placement statistics, and talk to our AI counselor.</p>
                    <button onClick={()=>setShowSignupPopup(true)} className="bg-maroon text-white px-8 py-3 rounded-lg font-semibold">Sign Up to Unlock</button>
                    <Footer/>
                </section>
            )}
