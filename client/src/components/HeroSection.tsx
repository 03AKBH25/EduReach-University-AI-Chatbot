        ...
        <section id="hero" className="relative h-[85vh] min-h-[500px]">
            ...
            <div className="relative z-10 h-full flex items-center">
                <div className="max-w-7xl mx-auto px-4 w-full">
                    ...
                    <p>
                        {siteConfig.tagline}. Premier engineering institution with 92% placement rate and partnerships with Google, Microsoft & Amazon.
                    </p>
                    <a href="#courses" className="inline-block bg-white text-maroon px-6 py-3 rounded-lg font-semibold hover:bg-amber-300 hover:text-maroon-dark transition-colors duration-300">
                        Explore Programs
                    </a>
                </div>
            </div>
